...
const Logo = ({ size }) => {
  return (
    <svg
      ...
      width={size ? setWidth(size) : setWidth()} height={size ? setHight(size) : setHight()} viewBox='0 0 346 107' enableBackground='new 0 0 346 107' xmlSpace='preserve'
    >
      <g>
        <polygon
          fill='#FF7101' points='21.832,68.239 21.832,66.308 21.832,60.115 37.832,51.519 37.832,39.162 21.832,47.759
          21.832,38.76 47.832,24.021 47.832,11.66 11.832,32.58 11.832,74.42 21.832,80.231'
        />
        <polygon
          fill='#FF7101' points='52.832,14.707 52.832,26.981 73.832,38.761 73.832,68.239 47.832,82.979 26.832,71.074
          26.832,83.137 47.832,95.34 83.832,74.42 83.832,32.58'
        />
      </g>
      <g>
        <polygon
          fill='#323232' points='141.65,36.659 123.079,36.659 123.079,51.593 140.195,51.593 140.195,58.558 123.079,58.558
                    123.079,79.349 114.832,79.349 114.832,29.66 141.65,29.66'
        />
        <path
          fill='#323232' d='M163.613,80.181c-5.474,0-9.848-1.658-13.115-4.973c-3.27-3.314-4.902-7.71-4.902-13.186
        ...
        />
        <path
          fill='#323232' d='M209.138,51.524c-0.971-0.763-2.369-1.144-4.192-1.144c-2.379,0-4.367,1.074-5.96,3.222
        ...
        />
        <path
          fill='#323232' d='M211.35,78.239V70.79c3.003,2.287,6.317,3.43,9.944,3.43c4.852,0,7.278-1.432,7.278-4.297
        ...
        />
        <path
          fill='#323232' d='M261.171,78.967c-1.57,0.785-3.639,1.179-6.202,1.179c-6.884,0-10.325-3.304-10.325-9.91V50.173h-5.926
        ...
        />
        <path
          fill='#323232' d='M296.026,63.79h-24.188c0.092,3.281,1.104,5.811,3.032,7.589c1.928,1.778,4.58,2.668,7.952,2.668
        ...
        />
        <polygon
          fill='#323232' points='334.168,79.349 323.982,79.349 310.191,62.3 310.052,62.3 310.052,79.349 301.98,79.349
